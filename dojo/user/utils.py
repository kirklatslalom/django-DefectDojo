...
def get_configuration_permissions_fields():
    ...
    if get_system_setting("enable_github"):
        github_permissions = [
            Permission_Helper(
                name="github conf", app="dojo", view=True, add=True, delete=True
            ),
        ]
    else:
        github_permissions = []
    ...
    if get_system_setting("enable_questionnaires"):
        questionnaire_permissions = [
            ...
            Permission_Helper(
                name="question", app="dojo", view=True, add=True, change=True
            ),
        ]
    else:
        questionnaire_permissions = []
    ...
    if get_system_setting("enable_rules_framework"):
        rules_permissions = [
            Permission_Helper(
                name="rule", app="auth", view=True, add=True, change=True, delete=True
            ),
        ]
    else:
        rules_permissions = []
    ...
    permission_fields = (
        ...
        + [
            Permission_Helper(
                name="regulation", app="dojo", add=True, change=True, delete=True
            )
        ]
        + rules_permissions
        + [
            ...
            Permission_Helper(
                name="user", app="auth", view=True, add=True, change=True, delete=True
            ),
        ]
    )
