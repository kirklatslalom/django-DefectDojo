...
urlpatterns = [
    #  findings
    re_path(r"^finding$", views.open_findings, {"view": "All"}, name="all_findings"),
    re_path(
    ...
    re_path(r"^finding/open$", views.open_findings, name="open_findings"),
    re_path(r"^finding/verified$", views.verified_findings, name="verified_findings"),
    re_path(
    ...
    re_path(
        r"^engagement/(?P<eid>\d+)/finding/verified$",
        views.verified_findings,
        name="engagement_verified_findings",
    ),
    re_path(
        r"^engagement/(?P<eid>\d+)/finding/accepted$",
    ...
    re_path(r"^finding/closed$", views.closed_findings, name="closed_findings"),
    re_path(r"^finding/accepted", views.accepted_findings, name="accepted_findings"),
    re_path(r"^finding/(?P<fid>\d+)$", views.view_finding, name="view_finding"),
    re_path(r"^finding/(?P<fid>\d+)/edit$", views.edit_finding, name="edit_finding"),
    re_path(r"^finding/(?P<fid>\d+)/touch", views.touch_finding, name="touch_finding"),
    re_path(
    ...
    re_path(
        r"^finding/(?P<fid>\d+)/delete$", views.delete_finding, name="delete_finding"
    ),
    re_path(r"^finding/(?P<fid>\d+)/copy$", views.copy_finding, name="copy_finding"),
    re_path(
        r"^finding/(?P<fid>\d+)/apply_cwe$",
        views.apply_template_cwe,
        name="apply_template_cwe",
    ),
    re_path(r"^finding/(?P<fid>\d+)/mktemplate$", views.mktemplate, name="mktemplate"),
    re_path(
    ...
    re_path(r"^finding/(?P<fid>\d+)/close$", views.close_finding, name="close_finding"),
    re_path(
        r"^finding/(?P<fid>\d+)/defect_review",
        views.defect_finding_review,
        name="defect_finding_review",
    ),
    re_path(r"^finding/(?P<fid>\d+)/open", views.reopen_finding, name="reopen_finding"),
    re_path(
    ...
    re_path(
        r"^finding/(?P<fid>\d+)/remediation_date",
    ...
    # template findings
    re_path(r"^template$", views.templates, name="templates"),
    re_path(r"^template/add$", views.add_template, name="add_template"),
    re_path(r"^template/(?P<tid>\d+)/edit$", views.edit_template, name="edit_template"),
    re_path(
        r"^template/(?P<tid>\d+)/delete", views.delete_template, name="delete_template"
    ),
    re_path(
        r"^template/export$", views.export_templates_to_json, name="export_template"
    ),
    re_path(
