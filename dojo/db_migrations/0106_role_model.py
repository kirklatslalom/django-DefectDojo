...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.RunSQL(
            "UPDATE dojo_product_type_member SET role = 5 WHERE (role = 0)"
        ),
        migrations.RunSQL(
            "UPDATE dojo_product_type_group SET role = 5 WHERE (role = 0)"
        ),
        ...
        migrations.AlterField(
            ...
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, to="dojo.role"
            ),
        ),
        migrations.AlterField(
