...
class Migration(migrations.Migration):
    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        default=None,
                        help_text=b"Scope of Engagement testing, IP's/Resources/URL's)",
                        max_length=800,
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "epic_name_id",
                    models.IntegerField(
                        help_text=b"To obtain the 'Epic name id' visit https://<YOUR JIRA URL>/rest/api/2/field and search for Epic Name. Copy the number out of cf[number] and paste it here."
                    ),
                ),
                (
                    "open_status_key",
                    models.IntegerField(
                        help_text=b"Transition ID to Re-Open JIRA issues, visit https://<YOUR JIRA URL>/rest/api/latest/issue/<ANY VALID ISSUE KEY>/transitions?expand=transitions.fields to find the ID for your JIRA instance"
                    ),
                ),
                (
                    "close_status_key",
                    models.IntegerField(
                        help_text=b"Transition ID to Close JIRA issues, visit https://<YOUR JIRA URL>/rest/api/latest/issue/<ANY VALID ISSUE KEY>/transitions?expand=transitions.fields to find the ID for your JIRA instance"
                    ),
                ),
                (
                    "low_mapping_severity",
                    models.CharField(
                        help_text=b"Maps to the 'Priority' field in Jira. For example: Low",
                        max_length=200,
                    ),
                ),
                (
                    ...
                    models.CharField(
                        help_text=b"Maps to the 'Priority' field in Jira. For example: Medium",
                        max_length=200,
                    ),
                ),
                (
                    ...
                    models.CharField(
                        help_text=b"Maps to the 'Priority' field in Jira. For example: High",
                        max_length=200,
                    ),
                ),
                (
                    ...
                    models.CharField(
                        help_text=b"Maps to the 'Priority' field in Jira. For example: Critical",
                        max_length=200,
                    ),
                ),
                (
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.TextField(
                        blank=True,
                        help_text=b"Information about the regulation's purpose.",
                    ),
                ),
                (
                    "reference",
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        default="",
                        help_text=b"URL prefix if DefectDojo is installed in it's own virtual subdirectory.",
                        max_length=300,
                    ),
                ),
                ...
                (
                    ...
                    models.BooleanField(
                        default=True,
                        help_text=b"Enables Finding SLA's for time to remediate.",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        help_text=b"Phone number must be entered in the format: '+999999999'. Up to 15 digits allowed.",
                        max_length=15,
                        validators=[
                            django.core.validators.RegexValidator(
                                message=b"Phone number must be entered in the format: '+999999999'. Up to 15 digits allowed.",
                                regex="^\\+?1?\\d{9,15}$",
                            )
                        ],
                    ),
                ...
                (
                    ...
                    models.BooleanField(
                        default=False,
                        help_text=b"Instead of async deduping a finding the findings will be deduped synchronously and will 'block' the user until completion.",
                    ),
                ),
            ],
        ),
        ...
        migrations.AddField(
            ...
            name="benchmark_type",
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, to="dojo.Benchmark_Type"
            ),
        ),
        migrations.AddField(
            model_name="benchmark_product_summary",
