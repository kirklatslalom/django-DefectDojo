...
def sq_clean(apps, schema_editor):
    ...
    if sqtc:
        for sq in Sonarqube_Product_model.objects.filter(
            ...
            logger.info(
                "Setting Product SonarQube Configuration for product {} to only existing SonarQube Tool "
        ...
        logger.warning(
            "No SonarQube tool configuration found, all invalid SonarQube configurations will be removed."
        )
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                ...
                to="dojo.sonarqube_product",
                verbose_name="SonarQube Config",
            ),
        ),
