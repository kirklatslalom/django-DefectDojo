...
class Migration(migrations.Migration):
    def set_risk_accepted_flag_on_findings(apps, schema_editor):
        ...
        logger.info(
            "Setting risk_accepted flag on findings that have an existing risk acceptance."
        )

        accepted_findings = apps.get_model("dojo", "Finding").objects.filter(
    ...
    operations = [
        ...
        migrations.RunPython(
            set_risk_accepted_flag_on_findings, migrations.RunPython.noop
        ),
