...
def update_collation(apps, schema_editor):
    ...
    schema_editor.execute(
        "ALTER TABLE dojo_sonarqube_issue CONVERT TO CHARACTER SET utf8mb4 COLLATE utf8mb4_bin"
    )
...
class Migration(migrations.Migration):
    ...
    replaces = [
        ...
        ("dojo", "0074_notifications_close_engagement"),
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        help_text=b"The communication protocol such as 'http', 'ftp', etc.",
                        max_length=10,
                        null=True,
                    ),
                ),
                (
                    ...
                    models.CharField(
                        blank=True,
                        help_text=b"The host name or IP address, you can also include the port number. For example'127.0.0.1', '127.0.0.1:8080', 'localhost', 'yourdomain.com'.",
                        max_length=500,
                        null=True,
                    ),
                ),
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        help_text=b"The location of the resource, it should start with a '/'. For example/endpoint/420/edit",
                        max_length=500,
                        null=True,
                    ),
                ),
                (
                    ...
                    models.CharField(
                        blank=True,
                        help_text=b"The query string, the question mark should be omitted.For example 'group=4&team=8'",
                        max_length=1000,
                        null=True,
                    ),
                ),
                (
                    ...
                    models.CharField(
                        blank=True,
                        help_text=b"The fragment identifier which follows the hash mark. The hash mark should be omitted. For example 'section-13', 'paragraph-2'.",
                        max_length=500,
                        null=True,
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "progress",
                    models.CharField(
                        default="threat_model", editable=False, max_length=100
                    ),
                ),
                (
                    "tmodel_path",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "line",
                    models.IntegerField(
                        blank=True, null=True, verbose_name="Line number"
                    ),
                ),
                ...
                (
                    ...
                    models.IntegerField(
                        ...
                        default=None,
                        editable=False,
                        help_text="Confidence level of vulnerability which is supplied by the scannner.",
                        null=True,
                    ),
                ),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "url",
                    models.URLField(
                        help_text="For more information how to configure Jira, read the DefectDojo documentation.",
                        max_length=2000,
                ...
                (
                    "epic_name_id",
                    models.IntegerField(
                        help_text="To obtain the 'Epic name id' visit https://<YOUR JIRA URL>/rest/api/2/field and search for Epic Name. Copy the number out of cf[number] and paste it here."
                    ),
                ),
                (
                    "open_status_key",
                    models.IntegerField(
                        help_text="Transition ID to Re-Open JIRA issues, visit https://<YOUR JIRA URL>/rest/api/latest/issue/<ANY VALID ISSUE KEY>/transitions?expand=transitions.fields to find the ID for your JIRA instance",
                        verbose_name="Reopen Transition ID",
                    ),
                ),
                (
                    "close_status_key",
                    models.IntegerField(
                        help_text="Transition ID to Close JIRA issues, visit https://<YOUR JIRA URL>/rest/api/latest/issue/<ANY VALID ISSUE KEY>/transitions?expand=transitions.fields to find the ID for your JIRA instance",
                        verbose_name="Close Transition ID",
                    ),
                ),
                (
                ...
                (
                    ...
                    models.TextField(
                        blank=True,
                        help_text="Additional text that will be added to the finding in Jira. For example including how the finding was created or who to contact for more information.",
                        null=True,
                    ),
                ),
                (
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        help_text="JIRA resolution names (comma-separated values) that maps to an Accepted Finding",
                        max_length=300,
                        null=True,
                    ),
                ),
                (
                    ...
                    models.CharField(
                        blank=True,
                        help_text="JIRA resolution names (comma-separated values) that maps to a False Positive Finding",
                        max_length=300,
                        null=True,
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "color",
                    models.CharField(
                        max_length=7, null=True, verbose_name="HTML color"
                    ),
                ),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "location",
                    models.CharField(
                        help_text="Location of network testing: Examples: VPN, Internet or Internal.",
                        max_length=500,
                    ),
                ),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "date",
                    models.DateTimeField(
                        default=dojo.models.get_current_datetime, editable=False
                    ),
                ),
                (
                    "author",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "folder",
                    models.CharField(
                        blank=True, max_length=400, null=True, verbose_name="Folder"
                    ),
                ),
                (
                    "artifact",
                    models.CharField(
                        blank=True, max_length=400, null=True, verbose_name="Artifact"
                    ),
                ),
                (
                    "created",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "object_id",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to="dojo.objects"
                    ),
                ),
            ],
        ),
            ...
            fields=[
                ...
                (
                    ...
                    models.PositiveIntegerField(
                        blank=True,
                        help_text="Estimate the number of user records within the application.",
                        null=True,
                    ),
                ),
                (
                ...
                (
                    ...
                    models.BooleanField(
                        default=False,
                        help_text="Specify if the application is used by people outside the organization.",
                    ),
                ),
                (
                    "internet_accessible",
                    models.BooleanField(
                        default=False,
                        help_text="Specify if the application is accessible from the public internet.",
                    ),
                ),
                (
                    "authorized_users",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(
                        help_text="The name of the legislation.", max_length=128
                    ),
                ),
                (
                    "acronym",
                ...
                (
                    "jurisdiction",
                    models.CharField(
                        help_text="The territory over which the regulation applies.",
                        max_length=64,
                    ),
                ),
                (
                ...
                (
                    "reference",
                    models.URLField(
                        blank=True, help_text="An external URL for more information."
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "operator",
                    models.CharField(
                        choices=[("Matches", "Matches"), ("Contains", "Contains")],
                        max_length=30,
                    ),
                ),
                (
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "api_key",
                    models.CharField(
                        blank=True, max_length=600, null=True, verbose_name="API Key"
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "how_to_test",
                    models.TextField(
                        default=None, help_text="How to test the objective"
                    ),
                ),
                (
                    "results_expected",
        ...
        migrations.AddField(
            ...
            name="test_type",
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, to="dojo.test_type"
            ),
        ),
        migrations.CreateModel(
            name="ScanSettings",
            ...
            fields=[
                ...
                (
                    ...
                    models.TextField(
                        blank=True,
                        default=None,
                        help_text="If a compensating control exists to mitigate the finding or reduce risk, then list the compensating control(s).",
                        null=True,
                    ),
                ),
                (
        ...
        migrations.AddField(
            ...
            name="product",
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, to="dojo.product"
            ),
        ),
        migrations.AddField(
            model_name="objects",
            name="review_status",
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, to="dojo.objects_review"
            ),
        ),
        migrations.CreateModel(
            name="Notifications",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "network_locations",
                    models.ManyToManyField(
                        blank=True, default=None, to="dojo.Network_Locations"
                    ),
                ),
                (
                    "product",
                ...
                (
                    "test_type",
                    models.ManyToManyField(
                        blank=True, default=None, to="dojo.Test_Type"
                    ),
                ),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name="risk_acceptance",
            field=models.ManyToManyField(
                blank=True, default=None, editable=False, to="dojo.Risk_Acceptance"
            ),
        ),
        migrations.AddField(
            model_name="engagement",
        ...
        migrations.AddField(
            ...
            name="endpoint_params",
            field=models.ManyToManyField(
                blank=True, editable=False, to="dojo.Endpoint_Params"
            ),
        ),
        migrations.AddField(
            model_name="endpoint",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "auth_issues",
                    models.ManyToManyField(
                        blank=True, related_name="auth_issues", to="dojo.Finding"
                    ),
                ),
                (
                    "author_issues",
                    models.ManyToManyField(
                        blank=True, related_name="author_issues", to="dojo.Finding"
                    ),
                ),
                (
                    "config_issues",
                    models.ManyToManyField(
                        blank=True, related_name="config_issues", to="dojo.Finding"
                    ),
                ),
                (
                    "crypto_issues",
                    models.ManyToManyField(
                        blank=True, related_name="crypto_issues", to="dojo.Finding"
                    ),
                ),
                (
                    "data_issues",
                    models.ManyToManyField(
                        blank=True, related_name="data_issues", to="dojo.Finding"
                    ),
                ),
                (
                    "engagement",
                ...
                (
                    "other_issues",
                    models.ManyToManyField(
                        blank=True, related_name="other_issues", to="dojo.Finding"
                    ),
                ),
                (
                    "sensitive_issues",
                    models.ManyToManyField(
                        blank=True, related_name="sensitive_issues", to="dojo.Finding"
                    ),
                ),
                (
                    "session_issues",
                    models.ManyToManyField(
                        blank=True, related_name="session_issues", to="dojo.Finding"
                    ),
                ),
            ],
        ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "confidence",
                    models.IntegerField(
                        blank=True, null=True, verbose_name="Confidence level"
                    ),
                ),
                (
                    "version",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "blank",
                    models.IntegerField(
                        blank=True, null=True, verbose_name="Number of blank lines"
                    ),
                ),
                (
                    "comment",
                    models.IntegerField(
                        blank=True, null=True, verbose_name="Number of comment lines"
                    ),
                ),
                (
                    "code",
                    models.IntegerField(
                        blank=True, null=True, verbose_name="Number of code lines"
                    ),
                ),
                (
                    "created",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "publish",
                    models.BooleanField(
                        default=False, help_text="Publish score to Product."
                    ),
                ),
                (
                    "created",
        ...
        migrations.AlterField(
            ...
            field=models.CharField(
                blank=True,
                help_text="The fragment identifier which follows the hash mark. The hash mark should be omitted. For example 'section-13', 'paragraph-2'.",
                max_length=500,
                null=True,
            ),
        ),
        migrations.AlterField(
            ...
            field=models.CharField(
                blank=True,
                help_text="The host name or IP address, you can also include the port number. For example'127.0.0.1', '127.0.0.1:8080', 'localhost', 'yourdomain.com'.",
                max_length=500,
                null=True,
            ),
        ),
        migrations.AlterField(
            ...
            field=models.CharField(
                blank=True,
                help_text="The location of the resource, it should start with a '/'. For example/endpoint/420/edit",
                max_length=500,
                null=True,
            ),
        ),
        ...
        migrations.AlterField(
            ...
            field=models.CharField(
                blank=True,
                help_text="The query string, the question mark should be omitted.For example 'group=4&team=8'",
                max_length=1000,
                null=True,
            ),
        ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.BooleanField(
                        default=False,
                        help_text="Instead of async deduping a finding the findings will be deduped synchronously and will 'block' the user until completion.",
                    ),
                ),
                (
                    "user",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "numerical_severity",
                    models.CharField(
                        blank=True, editable=False, max_length=4, null=True
                    ),
                ),
                (
                    "template_match",
                    models.BooleanField(
                        default=False,
                        help_text="Enables this template for matching remediation advice. Match will be applied to all active, verified findings by CWE.",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.BooleanField(
                        default=False,
                        help_text="With this setting turned on, Dojo deduplicates findings by comparing endpoints, cwe fields, and titles. If two findings share a URL and have the same CWE or title, Dojo marks the less recent finding as a duplicate. When deduplication is enabled, a list of deduplicated findings is added to the engagement view.",
                ...
                (
                    ...
                    models.IntegerField(
                        blank=True,
                        help_text="When enabled, if a single issue reaches the maximum number of duplicates, the oldest will be deleted.",
                        null=True,
                ...
                (
                    ...
                    models.BooleanField(
                        default=False, verbose_name="Enable Slack notifications"
                    ),
                ),
                (
                    "slack_channel",
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        default="",
                        help_text="Token required for interacting with Slack. Get one at https://api.slack.com/tokens",
                        max_length=100,
                    ),
                ),
                (
                ...
                (
                    ...
                    models.BooleanField(
                        default=False, verbose_name="Enable HipChat notifications"
                    ),
                ),
                (
                    "hipchat_site",
                    models.CharField(
                        blank=True,
                        default="",
                        help_text='The full fqdn of your hipchat site, e.g. "yoursite.hipchat.com"',
                        max_length=100,
                    ),
                ),
                (
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        default="",
                        help_text="Token required for interacting with HipChat. Get one at https://patriktest.hipchat.com/addons/",
                        max_length=100,
                    ),
                ),
                ...
                (
                    ...
                    models.CharField(
                        blank=True, default="from@example.com", max_length=200
                    ),
                ),
                (
                ...
                (
                    ...
                    models.BooleanField(
                        default=False,
                        help_text="With this setting turned on, Dojo will display S0, S1, S2, etc in most places, whereas if turned off Critical, High, Medium, etc will be displayed.",
                    ),
                ),
                (
                    ...
                    models.BooleanField(
                        default=False,
                        help_text="DefectDojo will automatically mark the finding as a false positive if the finding has been previously marked as a false positive.",
                    ),
                ),
                (
                    "url_prefix",
                    models.CharField(
                        blank=True,
                        default="",
                        help_text="URL prefix if DefectDojo is installed in it's own virtual subdirectory.",
                        max_length=300,
                    ),
                ),
                ...
                (
                    ...
                    models.BooleanField(
                        default=False,
                        help_text="Displays a grade letter next to a product to show the overall health.",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "key",
                    models.CharField(
                        help_text="SonarQube issue key", max_length=30, unique=True
                    ),
                ),
                (
                    "status",
                    models.CharField(help_text="SonarQube issue status", max_length=20),
                ),
                (
                    "type",
                    models.CharField(help_text="SonarQube issue type", max_length=15),
                ),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        ...
                        max_length=200,
                        null=True,
                        verbose_name="SonarQube Project Key",
                    ),
                ),
                (
                    "product",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        default="",
                        help_text="This message will be displayed on the login page. It can contain basic html tags, for example <a href='https://www.fred.com' style='color: #337ab7;' target='_blank'>https://example.com</a>",
                        max_length=500,
                    ),
                ),
            ],
        ...
        migrations.AddIndex(
            model_name="finding",
            index=models.Index(
                fields=["false_p"], name="dojo_findin_false_p_aac0c7_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="finding",
            index=models.Index(
                fields=["verified"], name="dojo_findin_verifie_beb0fc_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="finding",
            index=models.Index(
                fields=["mitigated"], name="dojo_findin_mitigat_946a13_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="finding",
        ...
        migrations.AddIndex(
            model_name="finding",
            index=models.Index(
                fields=["out_of_scope"], name="dojo_findin_out_of__26856e_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="finding",
            index=models.Index(
                fields=["numerical_severity"], name="dojo_findin_numeric_83d93b_idx"
            ),
        ),
        migrations.AlterField(
            model_name="finding",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        default="",
                        help_text="Enter your Github API Key",
                        max_length=2000,
                    ),
                ),
            ],
        ...
        migrations.AddField(
            ...
            name="enable_github",
            field=models.BooleanField(
                default=False, verbose_name="Enable GITHUB integration"
            ),
        ),
        migrations.CreateModel(
            name="GITHUB_Issue",
            fields=[
                ...
                (
                    "issue_url",
                    models.URLField(max_length=2000, verbose_name="GitHub issue URL"),
                ),
                (
                    "finding",
                    models.OneToOneField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        help_text="Specify your project location. (:user/:repo)",
                        max_length=200,
                ...
                (
                    ...
                    models.BooleanField(
                        blank=True,
                        default=False,
                        help_text="Notes added to findings will be automatically added to the corresponding github issue",
                    ),
                ),
                (
                    "git_conf",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "order",
                    models.PositiveIntegerField(
                        default=1, help_text="The render order"
                    ),
                ),
                (
                    "optional",
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        null=True,
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="polymorphic_dojo.question_set+",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "answer",
                    models.ManyToManyField(
                        help_text="The selected choices as the answer", to="dojo.Choice"
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "multichoice",
                    models.BooleanField(default=False, help_text="Select one or more"),
                ),
        ...
        migrations.AddField(
            ...
            name="answered_survey",
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, to="dojo.answered_survey"
            ),
        ),
        migrations.AddField(
            model_name="answer",
            ...
            field=models.ForeignKey(
                ...
                null=True,
                on_delete=django.db.models.deletion.CASCADE,
                related_name="polymorphic_dojo.answer_set+",
                to="contenttypes.contenttype",
            ),
        ),
        migrations.AddField(
            ...
            name="question",
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, to="dojo.question"
            ),
        ),
        migrations.AddField(
            ...
            name="name",
            field=models.CharField(
                default="Legacy acceptance",
                help_text="Descriptive name which in the future may also be used to group risk acceptances together across engagements and products",
                max_length=100,
            ),
        ),
        migrations.AlterField(
        ...
        migrations.AlterField(
            ...
            name="owner",
            field=models.ForeignKey(
                help_text="Only the owner and staff users can edit the risk acceptance.",
                on_delete=django.db.models.deletion.CASCADE,
                to="dojo.dojo_user",
            ),
        ),
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                blank=True,
                related_name="endpoint_endpoint_status",
                to="dojo.Endpoint_Status",
            ),
        ),
        migrations.AddField(
            model_name="finding",
        ...
        migrations.AddField(
            ...
            field=models.BooleanField(
                blank=True,
                default=False,
                verbose_name="Send SLA notifications as comment?",
            ),
        ),
        migrations.AlterField(
            model_name="engagement",
        ...
        migrations.AlterField(
            ...
            field=models.TextField(
                blank=True,
                editable=False,
                help_text="Filepath of the source code file in which the flaw is located.",
                null=True,
        ...
        migrations.AlterField(
            ...
            name="thread_id",
            field=models.IntegerField(
                default=0, editable=False, verbose_name="Thread ID"
            ),
        ),
        migrations.AlterField(
            model_name="finding",
        ...
        migrations.AddField(
            ...
            field=models.TextField(
                blank=True,
                editable=False,
                help_text="Temporary archive with tags from the previous tagging library we used",
            ),
        ),
        migrations.AddField(
            model_name="endpoint",
        ...
        migrations.AddField(
            ...
            field=tagulous.models.fields.TagField(
                ...
                to="dojo.Tagulous_App_Analysis_tags",
            ),
        ),
        migrations.AddField(
            model_name="endpoint",
        ...
        migrations.AddField(
            ...
            field=tagulous.models.fields.TagField(
                ...
                blank=True,
                force_lowercase=True,
                help_text="Add tags that help describe this object. Choose from the list or add new tags. Press Enter key to add.",
        ...
        migrations.AlterField(
            ...
            field=models.BooleanField(
                default=False,
                help_text="Requires next setting: maximum number of duplicates to retain.",
            ),
        ),
        migrations.AlterField(
            model_name="system_settings",
            ...
            field=models.IntegerField(
                blank=True,
                default=10,
                help_text="When enabled, if a single issue reaches the maximum number of duplicates, the oldest will be deleted. Duplicate will not be deleted when left empty. A value of 0 will remove all duplicates.",
                null=True,
                verbose_name="Max Duplicates",
            ),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "file",
                    models.FileField(
                        upload_to=dojo.models.UniqueUploadNameProvider("uploaded_files")
                    ),
                ),
            ],
        ),
        migrations.AddField(
            ...
            name="files",
            field=models.ManyToManyField(
                blank=True, editable=False, to="dojo.FileUpload"
            ),
        ),
        migrations.AddField(
            model_name="finding",
        ...
        migrations.AddField(
            ...
            field=models.BooleanField(
                blank=True,
                default=False,
                verbose_name="Send Risk Acceptance expiration notifications as comment?",
            ),
        ),
        migrations.AddField(
            model_name="notifications",
        ...
        migrations.AddField(
            ...
            field=models.BooleanField(
                default=True,
                help_text="Allows full risk acceptance using a risk acceptance form, expiration date, uploaded proof, etc.",
            ),
        ),
        migrations.AddField(
            model_name="product",
            ...
            field=models.BooleanField(
                default=False,
                help_text="Allows simple risk acceptance by checking/unchecking a checkbox.",
            ),
        ),
        migrations.AddField(
            model_name="risk_acceptance",
            ...
            field=models.CharField(
                ...
                default="A",
                help_text="Risk treatment decision by risk owner",
                max_length=2,
            ),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            field=models.DateTimeField(
                blank=True,
                default=None,
                help_text="(readonly) When the risk acceptance expiration was handled (manually or by the daily job).",
                null=True,
            ),
        ),
        migrations.AddField(
            ...
            field=models.DateTimeField(
                blank=True,
                default=None,
                help_text="(readonly) Date at which notice about the risk acceptance expiration was sent.",
                null=True,
            ),
        ),
        migrations.AddField(
            ...
            field=models.BooleanField(
                default=True,
                help_text="Reactivate findings when risk acceptance expires?",
        ...
        migrations.AddField(
            ...
            field=models.CharField(
                ...
                default="F",
                help_text="Recommendation from the security team.",
                max_length=2,
                verbose_name="Security Recommendation",
            ),
        ),
        migrations.AddField(
            model_name="risk_acceptance",
            ...
            field=models.TextField(
                blank=True,
                help_text="Explanation of security recommendation",
                null=True,
                verbose_name="Security Recommendation Details",
            ),
        ),
        migrations.AddField(
            model_name="risk_acceptance",
            ...
            field=models.BooleanField(
                default=False,
                help_text="When enabled, the SLA for findings is restarted when the risk acceptance expires.",
        ...
        migrations.AddField(
            ...
            field=models.IntegerField(
                blank=True,
                default=180,
                help_text="Default expiry period for risk acceptance form.",
                null=True,
            ),
        ),
        migrations.AddField(
            ...
            field=models.IntegerField(
                blank=True,
                default=10,
                help_text="Notify X days before risk acceptance expires. Leave empty to disable.",
                null=True,
                verbose_name="Risk acceptance expiration heads up days",
            ),
        ),
        migrations.AlterField(
            model_name="child_rule",
        ...
        migrations.AlterField(
            ...
            field=models.DateTimeField(
                blank=True,
                default=None,
                help_text="When the risk acceptance expires, the findings will be reactivated (unless disabled below).",
                null=True,
            ),
        ),
        migrations.AlterField(
            ...
            name="owner",
            field=models.ForeignKey(
                help_text="User in DefectDojo owning this acceptance. Only the owner and staff users can edit the risk acceptance.",
                on_delete=django.db.models.deletion.CASCADE,
                to="dojo.dojo_user",
            ),
        ),
        migrations.AlterField(
            ...
            field=models.FileField(
                blank=True, null=True, upload_to="risk/%Y/%m/%d", verbose_name="Proof"
            ),
        ),
        migrations.AlterField(
            model_name="rule",
        ...
        migrations.AddIndex(
            model_name="endpoint",
            index=models.Index(
                fields=["product", "mitigated"], name="dojo_endpoi_product_b80e9a_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="endpoint_status",
            index=models.Index(
                fields=["finding", "mitigated"], name="dojo_endpoi_finding_0fa5ce_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="endpoint_status",
            index=models.Index(
                fields=["endpoint", "mitigated"], name="dojo_endpoi_endpoin_d85400_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="engagement",
            index=models.Index(
                fields=["product", "active"], name="dojo_engage_product_16b039_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="finding",
            index=models.Index(
                fields=["test", "is_Mitigated"], name="dojo_findin_test_id_afee7e_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="finding",
            index=models.Index(
                fields=["test", "duplicate"], name="dojo_findin_test_id_52d78d_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="finding",
            index=models.Index(
                fields=["test", "out_of_scope"], name="dojo_findin_test_id_742a6f_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="finding",
            index=models.Index(
                fields=["test", "false_p"], name="dojo_findin_test_id_188e8a_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="finding",
            index=models.Index(
                fields=["test", "unique_id_from_tool", "duplicate"],
                name="dojo_findin_test_id_269acb_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="finding",
            index=models.Index(
                fields=["test", "hash_code", "duplicate"],
                name="dojo_findin_test_id_e54563_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="finding",
            index=models.Index(
                fields=["test", "component_name"], name="dojo_findin_test_id_396336_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="notifications",
            index=models.Index(
                fields=["user", "product"], name="dojo_notifi_user_id_575989_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="test",
            index=models.Index(
                fields=["engagement", "test_type"], name="dojo_test_engagem_bb6b41_idx"
            ),
        ),
        migrations.AlterField(
            model_name="system_settings",
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                through="dojo.Test_Import_Finding_Action", to="dojo.Finding"
            ),
        ),
        migrations.AddField(
            model_name="test_import",
        ...
        migrations.AddIndex(
            model_name="test_import",
            index=models.Index(
                fields=["created", "test", "type"],
                name="dojo_test_i_created_951f4e_idx",
            ),
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                ...
                through="dojo.Product_Type_Member",
                to=settings.AUTH_USER_MODEL,
            ),
        ),
        migrations.RenameField(
        ...
        migrations.AddField(
            ...
            field=models.CharField(
                blank=True,
                help_text="Additional definitions that will be consumed by scanner",
                max_length=255,
                null=True,
            ),
        ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "creator",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to="dojo.dojo_user"
                    ),
                ),
                ...
                (
                    "test",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to="dojo.test"
                    ),
                ),
            ],
            options={
        ...
        migrations.AddField(
            ...
            field=models.CharField(
                blank=True,
                help_text="Tag or branch that was tested, a reimport may update this field.",
                max_length=150,
                null=True,
                verbose_name="Branch/Tag",
            ),
        ...
        migrations.AddField(
            ...
            field=models.CharField(
                blank=True,
                help_text="Build ID that was tested, a reimport may update this field.",
                max_length=150,
                null=True,
                verbose_name="Build ID",
            ),
        ...
        migrations.AddField(
            ...
            field=models.CharField(
                blank=True,
                help_text="Commit hash tested, a reimport may update this field.",
                max_length=150,
                null=True,
                verbose_name="Commit Hash",
            ),
        ...
        migrations.AddIndex(
            model_name="finding",
            index=models.Index(
                fields=["duplicate_finding", "id"],
                name="dojo_findin_duplica_94e6c5_idx",
            ),
        ),
    ]
