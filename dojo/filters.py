            ...
            if field in self.form.fields:
                ...
                if exclude:
                    self.form.fields[field].label = (
                        "Not " + self.form.fields[field].label
                    )
...
class FindingFilterWithTags(DojoFilter):
    ...
    tag = CharFilter(
        field_name="tags__name", lookup_expr="icontains", label="Tag name contains"
    )
...
class ComponentFilter(ProductComponentFilter):
    test__engagement__product__prod_type = ModelMultipleChoiceFilter(
        queryset=Product_Type.objects.none(), label="Product Type"
    )
...
class EngagementDirectFilter(DojoFilter):
    ...
    version = CharFilter(
        field_name="version", lookup_expr="icontains", label="Engagement version"
    )
    test__version = CharFilter(
        field_name="test__version", lookup_expr="icontains", label="Test version"
    )
...
class EngagementFilter(DojoFilter):
    engagement__name = CharFilter(
        lookup_expr="icontains", label="Engagement name contains"
    )
    engagement__lead = ModelChoiceFilter(
        queryset=Dojo_User.objects.none(), label="Lead"
    )
    engagement__version = CharFilter(
        field_name="engagement__version",
        lookup_expr="icontains",
        label="Engagement version",
    )
    ...
    engagement__status = MultipleChoiceFilter(
        choices=ENGAGEMENT_STATUS_CHOICES, label="Status"
    )
...
class ApiEngagementFilter(DojoFilter):
    ...
    tag = CharFilter(
        field_name="tags__name", lookup_expr="icontains", help_text="Tag name contains"
    )
    ...
    product__tags__name = CharFieldInFilter(
    ...
    not_tag = CharFilter(
        field_name="tags__name",
        lookup_expr="icontains",
        help_text="Not Tag name contains",
        exclude="True",
    )
    not_tags = CharFieldInFilter(
        field_name="tags__name",
        lookup_expr="in",
        help_text="Comma seperated list of exact tags not present on model",
        exclude="True",
    )
    not_product__tags__name = CharFieldInFilter(
        field_name="product__tags__name",
        lookup_expr="in",
...
class ProductFilter(DojoFilter):
    ...
    name_exact = CharFilter(
        field_name="name", lookup_expr="iexact", label="Exact Product Name"
    )
    prod_type = ModelMultipleChoiceFilter(
        queryset=Product_Type.objects.none(), label="Product Type"
    )
    ...
    tag = CharFilter(
        field_name="tags__name", lookup_expr="icontains", label="Tag contains"
    )
...
class ApiFindingFilter(DojoFilter):
    ...
    test__test_type = NumberInFilter(
        field_name="test__test_type", lookup_expr="in", label="Test Type"
    )
    ...
    test__engagement__tags = CharFieldInFilter(
        field_name="test__engagement__tags",
        lookup_expr="in",
        help_text="Comma seperated list of exact tags present on engagement",
    )
    test__engagement__product__tags__name = CharFieldInFilter(
        field_name="test__engagement__product__tags__name",
        lookup_expr="in",
        help_text="Comma seperated list of exact tags present on product",
    )
    ...
    not_test__tags = CharFieldInFilter(
        field_name="test__tags__name",
        lookup_expr="in",
        help_text="Comma seperated list of exact tags not present on test",
        exclude="True",
    )
    ...
    not_test__engagement__product__tags__name = CharFieldInFilter(
        field_name="test__engagement__product__tags__name",
        lookup_expr="in",
        help_text="Comma seperated list of exact tags not present on product",
        exclude="True",
...
class FindingFilter(FindingFilterWithTags):
    ...
    vulnerability_id = CharFilter(
        method=vulnerability_id_filter, label="Vulnerability Id"
    )
    ...
    test__engagement = ModelMultipleChoiceFilter(
        queryset=Engagement.objects.none(), label="Engagement"
    )
    ...
    test = ModelMultipleChoiceFilter(queryset=Test.objects.none(), label="Test")

    test__engagement__version = CharFilter(
        lookup_expr="icontains", label="Engagement Version"
    )
    ...
    if is_finding_groups_enabled():
        finding_group = ModelMultipleChoiceFilter(
            queryset=Finding_Group.objects.none(), label="Finding Group"
        )
    ...
    if get_system_setting("enable_jira"):
        ...
        jira_creation = DateRangeFilter(
            field_name="jira_issue__jira_creation", label="JIRA Creation"
        )
        jira_change = DateRangeFilter(
            field_name="jira_issue__jira_change", label="JIRA Updated"
        )
    ...
    has_notes = BooleanFilter(
        field_name="notes", lookup_expr="isnull", exclude=True, label="Has notes"
    )
...
class AcceptedFindingFilter(FindingFilter):
    ...
    risk_acceptance__owner = ModelMultipleChoiceFilter(
        queryset=Dojo_User.objects.none(), label="Risk Acceptance Owner"
    )
...
class SimilarFindingFilter(FindingFilter):
    ...
    vulnerability_ids = CharFilter(
        method=custom_vulnerability_id_filter, label="Vulnerability Ids"
    )
...
class MetricsEndpointFilter(FilterSet):
    ...
    def __init__(self, *args, **kwargs):
        ...
        if self.pid:
            ...
            ].queryset = Engagement.objects.filter(product_id=self.pid).all()
        else:
            self.form.fields[
                "finding__test__engagement"
            ].queryset = get_authorized_engagements(
                Permissions.Engagement_View
            ).order_by(
                "name"
            )
...
class ApiTestFilter(DojoFilter):
    ...
    engagement__tags = CharFieldInFilter(
        field_name="engagement__tags",
        lookup_expr="in",
        help_text="Comma seperated list of exact tags present on engagement",
    )
    engagement__product__tags__name = CharFieldInFilter(
    ...
    not_engagement__product__tags__name = CharFieldInFilter(
        field_name="engagement__product__tags__name",
        lookup_expr="in",
        help_text="Comma seperated list of exact tags not present on product",
        exclude="True",
...
class TestImportFilter(DojoFilter):
    ...
    version_exact = CharFilter(
        field_name="version", lookup_expr="iexact", label="Version Exact"
    )
