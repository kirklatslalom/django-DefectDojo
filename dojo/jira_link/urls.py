...
urlpatterns = [
    ...
    re_path(
        r"^jira/webhook/(?P<secret>[\w-]+)$", views.webhook, name="jira_web_hook_secret"
    ),
    re_path(r"^jira/webhook/", views.webhook, name="jira_web_hook"),
    re_path(r"^jira/add", views.new_jira, name="add_jira"),
    re_path(r"^jira/(?P<jid>\d+)/edit$", views.edit_jira, name="edit_jira"),
    re_path(r"^jira/(?P<tid>\d+)/delete$", views.delete_jira, name="delete_jira"),
