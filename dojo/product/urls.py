...
urlpatterns = [
    ...
    re_path(r"^product/(?P<pid>\d+)$", views.view_product, name="view_product"),
    re_path(
        r"^product/(?P<pid>\d+)/components$",
    ...
    re_path(r"^product/(?P<pid>\d+)/edit$", views.edit_product, name="edit_product"),
    re_path(
        r"^product/(?P<pid>\d+)/delete$", views.delete_product, name="delete_product"
    ),
    ...
    re_path(
        r"^product/(?P<pid>\d+)/new_technology$",
        views.new_tech_for_prod,
        name="new_tech_for_prod",
    ),
    re_path(
        r"^technology/(?P<tid>\d+)/edit$", views.edit_technology, name="edit_technology"
    ),
    re_path(
    ...
    re_path(
        r"^product/(?P<pid>\d+)/edit_notifications$",
