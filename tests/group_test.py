...
class GroupTest(BaseTestCase):
    def test_create_group(self):
        ...
        self.assertTrue(
            self.is_success_message_present(text="Group was added successfully.")
        )
    ...
    def test_group_edit_name_and_global_role(self):
        ...
        # Assert status is success
        self.assertTrue(
            self.is_success_message_present(text="Group saved successfully.")
        )
    ...
    def test_add_group_member(self):
        ...
        self.assertTrue(
            self.is_success_message_present(text="Group members added successfully.")
        )
    ...
    def test_edit_group_member(self):
        ...
        # Assert the message to determine success status
        self.assertTrue(
            self.is_success_message_present(text="Group member updated successfully")
        )
    ...
    def test_delete_group_member(self):
        ...
        # Assert the message to determine success status
        self.assertTrue(
            self.is_success_message_present(text="Group member deleted successfully.")
        )
    ...
    def test_group_delete(self):
        ...
        self.assertTrue(
            self.is_success_message_present(
                text="Group and relationships successfully removed."
            )
        )
