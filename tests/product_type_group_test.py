...
class ProductTypeGroupTest(BaseTestCase):
    def test_group_add_product_type_group(self):
        ...
        self.assertTrue(
            self.is_success_message_present(
                text="Product type groups added successfully."
            )
        )
        ...
        self.assertEqual(
            driver.find_elements(By.NAME, "member_product_type_role")[0].text, "Reader"
        )
    ...
    def test_group_edit_product_type_group(self):
        ...
        self.assertTrue(
            self.is_success_message_present(
                text="Product type group updated successfully."
            )
        )
        ...
        self.assertEqual(
            driver.find_elements(By.NAME, "member_product_type_role")[0].text, "Owner"
        )
    ...
    def test_group_delete_product_type_group(self):
        ...
        self.assertTrue(
            self.is_success_message_present(
                text="Product type group deleted successfully."
            )
        )
    ...
    def test_product_type_add_product_type_group(self):
        ...
        # Query the site to determine if the member has been added
        self.assertEqual(
            driver.find_elements(By.NAME, "product_type_group_group")[0].text,
            "Group Name",
        )
        self.assertEqual(
            driver.find_elements(By.NAME, "product_type_group_role")[0].text, "Reader"
        )
    ...
    def test_product_type_edit_product_type_group(self):
        ...
        self.assertEqual(
            driver.find_elements(By.NAME, "product_type_group_role")[0].text,
            "Maintainer",
        )
