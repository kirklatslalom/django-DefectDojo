...
class FindingTest(BaseTestCase):
    ...
    def test_edit_finding(self):
        ...
        # finding Severity
        Select(driver.find_element(By.ID, "id_severity")).select_by_visible_text(
            "Critical"
        )
        # cvssv3
        ...
        self.assertTrue(
            self.is_success_message_present(text="Finding saved successfully")
        )
    ...
    def test_mark_finding_for_review(self):
        ...
        self.assertTrue(
            self.is_success_message_present(
                text="Finding marked for review and reviewers notified."
            )
        )
    ...
    def test_clear_review_from_finding(self):
        ...
        self.assertTrue(
            self.is_success_message_present(
                text="Finding review has been updated successfully."
            )
        )
    ...
    def test_close_finding(self):
        ...
        pre_status = driver.find_element(
            By.XPATH, '//*[@id="vuln_endpoints"]/tbody/tr/td[3]'
        ).text
        # Click on the 'dropdownMenu1 button'
        driver.find_element(By.ID, "dropdownMenu1").click()
        ...
        post_status = driver.find_element(
            By.XPATH, '//*[@id="remd_endpoints"]/tbody/tr/td[3]'
        ).text
        # Assert ot the query to dtermine status of failure
    ...
    def test_unaccept_finding(self):
        ...
        # Assert ot the query to dtermine status of failure
        self.assertTrue(
            self.is_success_message_present(text="Finding risk unaccepted.")
        )
        # Check to see if the endpoint was mitigated
        # Select and click on the particular finding to edit
        driver.find_element(By.LINK_TEXT, "App Vulnerable to XSS").click()
    ...
    def test_make_finding_a_template(self):
        ...
        self.assertTrue(
            self.is_success_message_present(
                text="Finding template added successfully. You may edit it here."
            )
        )
    ...
    def test_create_finding_from_template(self):
        ...
        driver.find_element(By.ID, "id_title").send_keys(
            "App Vulnerable to XSS from Template"
        )
        self.assertNoConsoleErrors()
        # Click the 'finished' button to submit
        # print("\nClicking on finished \n")
        ...
        self.assertTrue(
            self.is_success_message_present(
                text="Finding from template added successfully."
            )
        )
        self.assertTrue(
            self.is_text_present_on_page(text="App Vulnerable to XSS From Template")
        )
    ...
    def test_delete_finding_template(self):
        ...
        self.assertTrue(
            self.is_success_message_present(
                text="Finding Template deleted successfully."
            )
        )
    ...
    def test_import_scan_result(self):
        ...
        Select(driver.find_element(By.ID, "id_scan_type")).select_by_visible_text(
            "ZAP Scan"
        )
        ...
        self.assertTrue(
            self.is_success_message_present(
                text="ZAP Scan processed a total of 4 findings"
            )
        )
    ...
    def test_delete_finding(self):
        ...
        self.assertTrue(
            self.is_text_present_on_page(text="Finding deleted successfully")
        )
