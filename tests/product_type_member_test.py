...
class ProductTypeMemberTest(BaseTestCase):
    def test_user_add_product_type_member(self):
        ...
        if self.is_element_by_id_present("dropdownMenuAddProductTypeMember"):
            ...
            driver.execute_script(
                "document.getElementsByName('product_types')[0].style.display = 'inline'"
            )
            ...
            self.assertTrue(
                self.is_success_message_present(
                    text="Product type members added successfully."
                )
            )
            # Query the site to determine if the member has been added
            self.assertEqual(
                driver.find_elements(By.NAME, "member_product_type")[0].text,
                "Research and Development",
            )
            self.assertEqual(
                driver.find_elements(By.NAME, "member_product_type_role")[0].text,
                "Reader",
            )
        else:
            print("--------------------------------")
            print(
                "test_user_add_product_type_member: Not executed because legacy authorization is active"
            )
            print("--------------------------------")
    ...
    def test_user_edit_product_type_member(self):
        ...
        if self.is_element_by_id_present("dropdownMenuAddProductTypeMember"):
            ...
            self.assertTrue(
                self.is_success_message_present(
                    text="Product type member updated successfully."
                )
            )
            ...
            print("--------------------------------")
            print(
                "test_user_edit_product_type_member: Not executed because legacy authorization is active"
            )
            print("--------------------------------")
    ...
    def test_user_delete_product_type_member(self):
        ...
        if self.is_element_by_id_present("dropdownMenuAddProductTypeMember"):
            ...
            self.assertTrue(
                self.is_success_message_present(
                    text="Product type member deleted successfully."
                )
            )
            ...
            print("--------------------------------")
            print(
                "test_user_delete_product_type_member: Not executed because legacy authorization is active"
            )
            print("--------------------------------")
    ...
    def test_product_type_add_product_type_member(self):
        ...
        if self.is_element_by_id_present("dropdownMenuAddProductTypeMember"):
            ...
            driver.execute_script(
                "document.getElementsByName('users')[0].style.display = 'inline'"
            )
            ...
            # Query the site to determine if the member has been added
            self.assertEqual(
                driver.find_elements(By.NAME, "member_user")[1].text,
                "Proper Samuel (propersahm)",
            )
            self.assertEqual(
                driver.find_elements(By.NAME, "member_role")[1].text, "Reader"
            )
        else:
            print("--------------------------------")
            print(
                "test_product_type_add_product_type_member: Not executed because legacy authorization is active"
            )
            print("--------------------------------")
    ...
    def test_product_type_edit_product_type_member(self):
        ...
        if self.is_element_by_id_present("dropdownMenuAddProductTypeMember"):
            ...
            self.assertEqual(
                driver.find_elements(By.NAME, "member_role")[1].text, "Maintainer"
            )
        else:
            print("--------------------------------")
            print(
                "test_product_type_edit_product_type_member: Not executed because legacy authorization is active"
            )
            print("--------------------------------")
    ...
    def test_product_type_delete_product_type_member(self):
        ...
        if self.is_element_by_id_present("dropdownMenuAddProductTypeMember"):
            ...
            print("--------------------------------")
            print(
                "test_product_delete_product_member: Not executed because legacy authorization is active"
            )
            print("--------------------------------")
