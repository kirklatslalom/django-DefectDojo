...
class SLAConfigurationTest(BaseTestCase):
    ...
    def test_add_sla_config(self):
        ...
        driver.find_element(By.ID, "id_description").send_keys(
            "This is a Test SLA Configuration for the purposes of testing"
        )
        ...
        self.assertTrue(
            self.is_success_message_present(
                text="SLA configuration Successfully Created."
            )
        )
    ...
    def test_edit_sla_config(self):
        ...
        driver.find_element(By.ID, "id_name").send_keys(
            "Edited Test SLA Configuration test"
        )
        driver.find_element(By.ID, "submit").click()
        self.assertTrue(
            self.is_success_message_present(
                text="SLA configuration Successfully Updated."
            )
        )
    ...
    def test_delete_sla_config(self):
        ...
        self.assertTrue(
            self.is_success_message_present(text="SLA configuration Deleted.")
        )
    ...
    def test_delete_default_sla(self):
        ...
        driver.find_element(By.ID, "delete").click()
        self.assertTrue(
            self.is_error_message_present(
                text="The Default SLA Configuration cannot be deleted."
            )
        )
