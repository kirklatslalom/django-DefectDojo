...
class ProductMemberTest(BaseTestCase):
        ...
        if self.is_element_by_id_present("dropdownMenuAddProductMember"):
            ...
            self.assertTrue(
                self.is_success_message_present(
                    text="Product members added successfully."
                )
            )
            ...
            print("--------------------------------")
            print(
                "test_user_add_product_member: Not executed because legacy authorization is active"
            )
            print("--------------------------------")
    ...
    def test_user_edit_product_member(self):
        ...
        if self.is_element_by_id_present("dropdownMenuAddProductMember"):
            ...
            self.assertTrue(
                self.is_success_message_present(
                    text="Product member updated successfully."
                )
            )
            ...
            self.assertEqual(
                driver.find_elements(By.NAME, "member_product_role")[0].text,
                "Maintainer",
            )
        else:
            print("--------------------------------")
            print(
                "test_edit_add_product_member: Not executed because legacy authorization is active"
            )
            print("--------------------------------")
    ...
    def test_user_delete_product_member(self):
        ...
        if self.is_element_by_id_present("dropdownMenuAddProductMember"):
            ...
            self.assertTrue(
                self.is_success_message_present(
                    text="Product member deleted successfully."
                )
            )
            ...
            print("--------------------------------")
            print(
                "test_user_delete_product_member: Not executed because legacy authorization is active"
            )
            print("--------------------------------")
    ...
    def test_product_add_product_member(self):
        ...
        if self.is_element_by_id_present("dropdownMenuAddProductMember"):
            ...
            # Query the site to determine if the member has been added
            self.assertEqual(
                driver.find_elements(By.NAME, "member_user")[0].text,
                "Proper Samuel (propersahm)",
            )
            self.assertEqual(
                driver.find_elements(By.NAME, "member_role")[0].text, "Reader"
            )
        else:
            print("--------------------------------")
            print(
                "test_product_add_product_member: Not executed because legacy authorization is active"
            )
            print("--------------------------------")
    ...
    def test_product_edit_product_member(self):
        ...
        if self.is_element_by_id_present("dropdownMenuAddProductMember"):
            ...
            self.assertEqual(
                driver.find_elements(By.NAME, "member_role")[0].text, "Maintainer"
            )
        else:
            print("--------------------------------")
            print(
                "test_product_edit_product_member: Not executed because legacy authorization is active"
            )
            print("--------------------------------")
