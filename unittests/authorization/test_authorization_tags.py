...
class TestAuthorizationTags(DojoTestCase):
    ...
    def test_has_object_permission_has_permission(
        self, mock_current_user, mock_has_permission
    ):
    ...
    @patch("crum.get_current_user")
    def test_has_configuration_permission(
        self, mock_current_user, mock_configuration_permission
    ):
