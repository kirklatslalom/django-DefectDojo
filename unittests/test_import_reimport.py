...
class ImportReimportMixin(object):
    def __init__(self, *args, **kwargs):
        ...
        self.zap_sample1_filename = (
            self.scans_path + "zap/1_zap_sample_0_and_new_absent.xml"
        )
        self.zap_sample2_filename = (
            self.scans_path + "zap/2_zap_sample_0_and_new_endpoint.xml"
        )
        self.zap_sample3_filename = (
            self.scans_path + "zap/3_zap_sampl_0_and_different_severities.xml"
        )
        ...
        self.gitlab_dep_scan_components_filename = (
            self.scans_path
            + "gitlab_dep_scan/gl-dependency-scanning-report-many-vuln.json"
        )
        ...
        self.sonarqube_file_name2 = (
            self.scans_path + "sonarqube/sonar-6-findings-1-unique_id_changed.html"
        )
        ...
        self.veracode_same_hash_code_different_unique_id = (
            self.scans_path
            + "veracode/many_findings_same_hash_code_different_unique_id.xml"
        )
        self.veracode_same_unique_id_different_hash_code = (
            self.scans_path
            + "veracode/many_findings_same_unique_id_different_hash_code.xml"
        )
        self.veracode_different_hash_code_different_unique_id = (
            self.scans_path
            + "veracode/many_findings_different_hash_code_different_unique_id.xml"
        )
        self.veracode_mitigated_findings = (
            self.scans_path + "veracode/mitigated_finding.xml"
        )
        ...
        self.generic_filename_with_file = (
            self.scans_path + "generic/test_with_image.json"
        )

        self.aws_prowler_file_name = self.scans_path + "aws_prowler/many_vuln.json"
        self.aws_prowler_file_name_plus_one = (
            self.scans_path + "aws_prowler/many_vuln_plus_one.json"
        )
        ...
        self.gitlab_dast_file_name = (
            self.scans_path + "gitlab_dast/gitlab_dast_one_vul.json"
        )
        self.scan_type_gitlab_dast = "GitLab DAST Report"

        self.anchore_grype_file_name = (
            self.scans_path + "anchore_grype/check_all_fields.json"
        )
    ...
    def test_zap_scan_base_active_verified(self):
        ...
        endpoint_status_count_before_active = self.db_endpoint_status_count(
            mitigated=False
        )
        endpoint_status_count_before_mitigated = self.db_endpoint_status_count(
            mitigated=True
        )
        notes_count_before = self.db_notes_count()

        with assertTestImportModelsCreated(
            self, imports=1, affected_findings=4, created=4
        ):
        ...
        self.assertEqual(
            endpoint_status_count_before_active + 7,
            self.db_endpoint_status_count(mitigated=False),
        )
        self.assertEqual(
            endpoint_status_count_before_mitigated,
            self.db_endpoint_status_count(mitigated=True),
        )
    ...
    def test_zap_scan_base_not_active_not_verified(self):
        ...
        with assertTestImportModelsCreated(
            ...
            import0 = self.import_scan_with_params(
                self.zap_sample0_filename, active=False, verified=False
            )
    ...
    def test_import_default_scan_date_parser_sets_date(self):
        ...
        with assertTestImportModelsCreated(
            self, imports=1, affected_findings=1, created=1
        ):
            import0 = self.import_scan_with_params(
    ...
    def test_import_set_scan_date_parser_not_sets_date(self):
        ...
        with assertTestImportModelsCreated(
            ...
            import0 = self.import_scan_with_params(
                self.zap_sample0_filename,
                active=False,
                verified=False,
                scan_date="2006-12-26",
            )
    ...
    def test_import_reimport_scan_date_parser_no_date(self):
        ...
        reimport0 = self.reimport_scan_with_params(
            test_id, self.zap_sample1_filename, scan_date="2020-02-02"
        )
    ...
    def test_import_reimport_no_scan_date_parser_date(self):
        import0 = self.import_scan_with_params(
            self.aws_prowler_file_name, scan_type=self.scan_type_aws_prowler
        )
        ...
        reimport0 = self.reimport_scan_with_params(
            test_id,
            self.aws_prowler_file_name_plus_one,
            scan_type=self.scan_type_aws_prowler,
        )
    ...
    def test_sonar_detailed_scan_base_active_verified(self):
        ...
        with assertTestImportModelsCreated(
            self, imports=1, affected_findings=6, created=6
        ):
            import0 = self.import_scan_with_params(
    ...
    def test_veracode_scan_base_active_verified(self):
        ...
        with assertTestImportModelsCreated(
            ...
            import0 = self.import_scan_with_params(
                self.veracode_many_findings, scan_type=self.scan_type_veracode
            )
    ...
    def test_import_veracode_reimport_veracode_active_verified_mitigated(self):
        logger.debug(
            "reimporting exact same original veracode mitigated xml report again"
        )

        import_veracode_many_findings = self.import_scan_with_params(
            self.veracode_mitigated_findings,
        ...
        with assertTestImportModelsCreated(
            ...
            reimport_veracode_mitigated_findings = self.reimport_scan_with_params(
                test_id,
                self.veracode_mitigated_findings,
                scan_type=self.scan_type_veracode,
            )
    ...
    def test_import_0_reimport_0_active_verified(self):
        ...
        with assertTestImportModelsCreated(self, reimports=1, untouched=4):
            reimport0 = self.reimport_scan_with_params(
                test_id, self.zap_sample0_filename
            )
    ...
    def test_import_0_reimport_0_active_not_verified(self):
        logger.debug(
            "reimporting exact same original zap xml report again, verified=False"
        )
        ...
        with assertTestImportModelsCreated(self, reimports=1, untouched=4):
            reimport0 = self.reimport_scan_with_params(
                test_id, self.zap_sample0_filename, verified=False
            )
    ...
    def test_import_sonar1_reimport_sonar1_active_not_verified(self):
        logger.debug(
            "reimporting exact same original sonar report again, verified=False"
        )
        ...
        with assertTestImportModelsCreated(self, reimports=1, untouched=6):
            reimportsonar1 = self.reimport_scan_with_params(
                test_id,
                self.sonarqube_file_name1,
                scan_type=self.scan_type_sonarqube_detailed,
                verified=False,
            )
    ...
    def test_import_veracode_reimport_veracode_active_not_verified(self):
        logger.debug(
            "reimporting exact same original veracode report again, verified=False"
        )
        ...
        # reimport exact same report
        with assertTestImportModelsCreated(self, reimports=1, untouched=4):
            reimport_veracode_many_findings = self.reimport_scan_with_params(
                test_id,
                self.veracode_many_findings,
                scan_type=self.scan_type_veracode,
                verified=False,
            )
    ...
    def test_import_sonar1_reimport_sonar2(self):
        logger.debug(
            "reimporting same findings except one with a different unique_id_from_tool"
        )
        ...
        with assertTestImportModelsCreated(
            self, reimports=1, affected_findings=2, created=1, closed=1, untouched=5
        ):
            reimportsonar1 = self.reimport_scan_with_params(
                test_id,
                self.sonarqube_file_name2,
    ...
    def test_import_veracode_reimport_veracode_same_hash_code_different_unique_id(self):
        logger.debug(
            "reimporting report with one finding having same hash_code but different unique_id_from_tool, verified=False"
        )
    ...
    def test_import_veracode_reimport_veracode_same_unique_id_different_hash_code(self):
        logger.debug(
            "reimporting report with one finding having same unique_id_from_tool but different hash_code, verified=False"
        )
    ...
    # - existing findings with verified is true should stay verified
    def test_import_veracode_reimport_veracode_different_hash_code_different_unique_id(
        self,
    ):
        logger.debug(
            "reimporting report with one finding having different hash_code and different unique_id_from_tool, verified=False"
        )
        ...
        # reimport
        with assertTestImportModelsCreated(
            self, reimports=1, affected_findings=2, created=1, closed=1, untouched=3
        ):
            reimport_veracode_many_findings = self.reimport_scan_with_params(
                test_id,
                self.veracode_different_hash_code_different_unique_id,
    ...
    def test_import_0_reimport_1_active_not_verified(self):
        logger.debug(
            "reimporting updated zap xml report, 1 new finding and 1 no longer present, verified=False"
        )
        ...
        with assertTestImportModelsCreated(
            ...
            reimport1 = self.reimport_scan_with_params(
                test_id, self.zap_sample1_filename, verified=False
            )
        ...
        self.assertEqual(
            endpoint_status_count_before_active + 2 - 3,
            self.db_endpoint_status_count(mitigated=False),
        )
        self.assertEqual(
            endpoint_status_count_before_mitigated + 2,
            self.db_endpoint_status_count(mitigated=True),
        )
    ...
    def test_import_0_reimport_1_active_verified_reimport_0_active_verified(self):
        logger.debug(
            "reimporting updated zap xml report, 1 new finding and 1 no longer present, verified=True and then 0 again"
        )
        ...
        self.assertEqual(
            endpoint_status_count_before_active - 3 + 2,
            self.db_endpoint_status_count(mitigated=False),
        )
        self.assertEqual(
            endpoint_status_count_before_mitigated + 2,
        ...
        with assertTestImportModelsCreated(
            self, reimports=1, affected_findings=2, closed=1, reactivated=1, untouched=3
        ):
            reimport0 = self.reimport_scan_with_params(
                test_id, self.zap_sample0_filename
            )
        ...
        self.assertEqual(
            endpoint_status_count_before_mitigated - 3 + 2,
            self.db_endpoint_status_count(mitigated=True),
        )
    ...
    def test_import_0_reimport_2_extra_endpoint(self):
        logger.debug(
            "reimporting exact same original zap xml report again, with an extra endpoint for zap1"
        )
        ...
        with assertTestImportModelsCreated(
            self, reimports=1, affected_findings=0, untouched=4
        ):
            reimport2 = self.reimport_scan_with_params(
                test_id, self.zap_sample2_filename
            )
        ...
        self.assertEqual(
            endpoint_status_count_before_active + 1,
            self.db_endpoint_status_count(mitigated=False),
        )
        self.assertEqual(
            endpoint_status_count_before_mitigated,
    ...
    def test_import_0_reimport_2_extra_endpoint_reimport_0(self):
        ...
        self.assertEqual(
            endpoint_status_count_before_mitigated + 1,
            self.db_endpoint_status_count(mitigated=True),
        )
    ...
    def test_import_0_reimport_3_active_verified(self):
        logger.debug(
            "reimporting updated zap xml report, with different severities for zap2 and zap5"
        )
        ...
        # reimport updated report
        with assertTestImportModelsCreated(
            self, reimports=1, affected_findings=4, created=2, closed=2, untouched=2
        ):
            reimport1 = self.reimport_scan_with_params(
                test_id, self.zap_sample3_filename
            )
        ...
        for finding in findings["results"]:
            if "Zap2" in finding["title"]:
                ...
                self.assertTrue(
                    not finding["active"] or finding["severity"] == "Medium"
                )
                zap2_ok = True
        ...
        self.assertEqual(endpoint_count_before, self.db_endpoint_count())
        self.assertEqual(
            endpoint_status_count_before_active + 3 + 3 - 3 - 3,
            self.db_endpoint_status_count(mitigated=False),
        )
        self.assertEqual(
            endpoint_status_count_before_mitigated + 2 + 2,
            self.db_endpoint_status_count(mitigated=True),
        )
    ...
    def test_import_reimport_without_closing_old_findings(self):
        ...
        with assertTestImportModelsCreated(
            self, reimports=1, affected_findings=1, created=1, untouched=3
        ):
            reimport1 = self.reimport_scan_with_params(
                test_id, self.zap_sample2_filename, close_old_findings=False
            )
    ...
    def test_import_0_reimport_0_anchore_file_path(self):
        import0 = self.import_scan_with_params(
            self.anchore_file_name, scan_type=self.scan_type_anchore
        )
        ...
        with assertTestImportModelsCreated(
            ...
            reimport0 = self.reimport_scan_with_params(
                test_id, self.anchore_file_name, scan_type=self.scan_type_anchore
            )
        ...
        self.assert_finding_count_json(
            active_findings_count_before, active_findings_after
        )
    ...
    def test_import_reimport_keep_false_positive_and_out_of_scope(self):
        logger.debug(
            "importing zap0 with 4 findings, manually setting 3 findings to active=False, reimporting zap0 must return only 1 finding active=True"
        )
        ...
        with assertTestImportModelsCreated(
            self, reimports=1, affected_findings=1, created=1
        ):
            reimport0 = self.reimport_scan_with_params(
                test_id, self.zap_sample0_filename
            )
    ...
    def test_import_6_reimport_6_gitlab_dep_scan_component_name_and_version(self):
        ...
        with assertTestImportModelsCreated(
            self, reimports=1, affected_findings=0, created=0, untouched=6
        ):
            reimport0 = self.reimport_scan_with_params(
                test_id,
                self.gitlab_dep_scan_components_filename,
        ...
        for finding in active_findings_after["results"]:
            if "v0.0.0-20190219172222-a4c6cb3142f2" == finding["component_version"]:
                self.assertEqual(
                    "CVE-2020-29652: Nil Pointer Dereference", finding["title"]
                )
                self.assertEqual(
                    "CVE-2020-29652",
    ...
    def test_import_param_close_old_findings_with_additional_endpoint(self):
        ...
        with assertTestImportModelsCreated(
            ...
            import0 = self.import_scan_with_params(
                self.clair_few_findings,
                scan_type=self.scan_type_clair,
        ...
        engagement_findings = Finding.objects.filter(
            test__engagement_id=1,
        ...
        with assertTestImportModelsCreated(
            self, imports=1, affected_findings=4, closed=4
        ):
        ...
        engagement_findings_count = Finding.objects.filter(
            test__engagement_id=1,
            test__test_type=test.test_type,
            active=True,
            is_mitigated=False,
    ...
    def test_import_param_close_old_findings_with_different_services(self):
        ...
        # reimport empty report
        with assertTestImportModelsCreated(
            self, imports=1, affected_findings=0, closed=0
        ):
            self.import_scan_with_params(
                self.clair_empty,
                scan_type=self.scan_type_clair,
    ...
    def test_import_reimport_generic(self):
        ...
        import0 = self.import_scan_with_params(
            self.generic_filename_with_file, scan_type="Generic Findings Import"
        )
    ...
    def test_import_nuclei_emptyc(self):
        ...
        import0 = self.import_scan_with_params(
            self.nuclei_empty, scan_type="Nuclei Scan"
        )

        test_id = import0["test"]

        reimport0 = self.reimport_scan_with_params(
            test_id, self.nuclei_empty, scan_type="Nuclei Scan"
        )
    ...
    def test_import_reimport_vulnerability_ids(self):
        ...
        import0 = self.import_scan_with_params(
            self.anchore_grype_file_name, scan_type=self.anchore_grype_scan_type
        )
...
class ImportReimportTestAPI(DojoAPITestCase, ImportReimportMixin):
    ...
    # - total  findings count should be 5
    # - zap1 active, zap4 inactive
    def test_import_0_reimport_1_active_verified_reimport_0_active_verified_statistics(
        self,
    ):
        logger.debug(
            "reimporting updated zap xml report, 1 new finding and 1 no longer present, verified=True and then 0 again"
    ...
    def test_import_0_reimport_1_active_verified_reimport_0_active_verified_statistics_no_history(
        self,
    ):
        logger.debug(
            "reimporting updated zap xml report, 1 new finding and 1 no longer present, verified=True and then 0 again"
        ...
        with assertTestImportModelsCreated(
            self, reimports=0, affected_findings=0, closed=0, reactivated=0, untouched=0
        ):
            reimport0 = self.reimport_scan_with_params(
                test_id, self.zap_sample0_filename
            )
    ...
    def test_reimport_default_scan_date_parser_not_sets_date(self):
        ...
        with assertTestImportModelsCreated(
            ...
            import0 = self.reimport_scan_with_params(
                ...
                product_type_name=PRODUCT_TYPE_NAME_DEFAULT,
...
class ImportReimportTestUI(DojoAPITestCase, ImportReimportMixin):
    ...
    def import_scan_ui(self, engagement, payload):
        ...
        response = self.client_ui.post(
            reverse("import_scan_results", args=(engagement,)), payload
        )
        # print(vars(response))
    ...
    def reimport_scan_ui(self, test, payload):
        response = self.client_ui.post(
            reverse("re_import_scan_results", args=(test,)), payload
        )
        self.assertEqual(302, response.status_code, response.content[:1000])
        test = Test.objects.get(id=response.url.split("/")[-1])
        return {"test": test.id}

    def import_scan_with_params_ui(
        self,
        filename,
        scan_type="ZAP Scan",
        engagement=1,
    ...
    def reimport_scan_with_params_ui(
        self,
        test_id,
        filename,
        scan_type="ZAP Scan",
