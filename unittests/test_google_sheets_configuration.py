...
class GoogleSheetsConfigTestApi(DojoVCRTestCase):
    ...
    def _get_vcr(self, **kwargs):
        ...
        my_vcr.cassette_library_dir = (
            os.path.dirname(os.path.abspath(__file__)) + "/vcr/google_sheets/"
        )
        return my_vcr
    ...
    def test_config_google_sheets(self):
        ...
        with open("tests/test-dojo-sheets-NONEXISTING.json", "rb") as f:
            ...
            response = self.client.post(
                reverse("configure_google_sheets"), data, follow=True
            )
