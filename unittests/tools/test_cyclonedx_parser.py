    ...
    def test_grype_report(self):
        with open("unittests/scans/cyclonedx/grype_dd_1_14_1.xml") as file:
            ...
            with self.subTest(i=0):
                ...
                self.assertEqual(
                    datetime.date(2021, 4, 13), datetime.datetime.date(finding.date)
                )
    ...
    def test_spec1_report(self):
        ...
        with open("unittests/scans/cyclonedx/spec1.xml") as file:
            ...
            with self.subTest(i=0):
                ...
                self.assertEqual(
                    "CVSS:3.1/AV:N/AC:L/PR:N/UI:N/S:U/C:H/I:H/A:H", finding.cvssv3
                )
    ...
    def test_cyclonedx_grype_11_report(self):
        ...
        with open("unittests/scans/cyclonedx/dd_1_15_0.xml") as file:
            ...
            with self.subTest(i=5):
                ...
                self.assertEqual(
                    "1:9.11.5.P4+dfsg-5.1+deb10u3", finding.component_version
                )
            with self.subTest(i=379):
                ...
                self.assertIn(
                    "urn:uuid:be0e9032-5b6b-4ce4-9be4-e5956a0309c1", finding.description
                )
            ...
            with self.subTest(i=380):
                ...
                self.assertIn(
                    "urn:uuid:17a8ccee-f13b-4d9d-abfc-f3964597df9a", finding.description
                )
    ...
    def test_cyclonedx_1_4_xml(self):
        ...
        with open("unittests/scans/cyclonedx/valid-vulnerability-1.4.xml") as file:
            ...
            with self.subTest(i=0):
                ...
                self.assertEqual(
                    "SNYK-JAVA-COMFASTERXMLJACKSONCORE-32111", finding.vuln_id_from_tool
                )
                vulnerability_ids = finding.unsaved_vulnerability_ids
                self.assertEqual(3, len(vulnerability_ids))
                self.assertEqual(
                    "SNYK-JAVA-COMFASTERXMLJACKSONCORE-32111", vulnerability_ids[0]
                )
            ...
            for finding in findings:
                ...
                if "c7129ff8-08bc-4afe-82ec-7d97b9491741" == finding.vuln_id_from_tool:
                    with self.subTest(i="CVE-2021-33203"):
                        self.assertIn(finding.severity, Finding.SEVERITIES)
                        self.assertEqual(
                            "Django:2.0 | c7129ff8-08bc-4afe-82ec-7d97b9491741",
                            finding.title,
                        )
                    ...
                    "c9b6a6a5-01a4-4d4c-b480-b9d6825dc4d0" == finding.vuln_id_from_tool
                ):
                    ...
                    "90cfba6a-ddc9-4708-b131-5d875e8c558d" == finding.vuln_id_from_tool
                ):
