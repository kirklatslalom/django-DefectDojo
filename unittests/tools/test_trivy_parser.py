...
"""
        ...
        self.assertEqual(
            "Add 'USER <non root user name>' line to the Dockerfile", finding.mitigation
        )
...
https://docs.docker.com/develop/develop-images/dockerfile_best-practices/"""
        ...
        finding = findings[3]
        self.assertEqual(
            "Secret detected in Dockerfile - GitHub Personal Access Token",
            finding.title,
        )
...
"""
        ...
        finding = findings[10]
        self.assertEqual(
            "KSV001 - Process can elevate its own privileges", finding.title
        )
        self.assertEqual("Medium", finding.severity)
