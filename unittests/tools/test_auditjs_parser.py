...
class TestAuditJSParser(DojoTestCase):
    ...
    def test_auditjs_parser_with_one_criticle_vuln_has_one_findings(self):
        ...
        self.assertEqual(
            "CVSS:3.1/AV:A/AC:L/PR:N/UI:N/S:C/C:H/I:H/A:H", findings[0].cvssv3
        )
        self.assertEqual(
            "da5a3b11-c75b-48e7-9c28-1123f0a492bf", findings[0].unique_id_from_tool
        )
        self.assertEqual("Unverified Certificate", findings[0].title)
        self.assertEqual(
            "> When using SSL to connect to a MySQL server, the SSL procedure implemented does not actually check if the remote server has a trusted certificate or not.\n> \n> -- [github.com](https://github.com/mysqljs/mysql/issues/816)",
    ...
    def test_auditjs_parser_with_many_vuln_has_many_findings(self):
        ...
        self.assertEqual(
            "CVSS:3.0/AV:N/AC:L/PR:L/UI:R/S:C/C:L/I:L/A:N", findings[0].cvssv3
        )
        self.assertEqual(
            "7df31426-09a2-4b5f-a0ab-acc699023c57", findings[0].unique_id_from_tool
        )
        self.assertEqual(
        ...
        self.assertEqual(
            "[CVE-2018-3717] connect node module before 2.14.0 suffers from a Cross-Site Scripting (XSS) vuln...",
            findings[0].title,
        )
        ...
        self.assertEqual(
            "https://ossindex.sonatype.org/vulnerability/7df31426-09a2-4b5f-a0ab-acc699023c57?component-type=npm&component-name=connect&utm_source=auditjs&utm_medium=integration&utm_content=4.0.25",
            findings[0].references,
        )
