...
def dummy_rule_wo_html_desc(self, *args, **kwargs):
    with open(
        get_unit_tests_path() + "/scans/sonarqube_api/rule_wo_html_desc.json"
    ) as json_file:
        data = json.load(json_file)
        return data
...
def dummy_no_hotspot(self, *args, **kwargs):
    with open(
        get_unit_tests_path() + "/scans/sonarqube_api/hotspots/no_vuln.json"
    ) as json_file:
        data = json.load(json_file)
        return data
...
def dummy_one_hotspot(self, *args, **kwargs):
    with open(
        get_unit_tests_path() + "/scans/sonarqube_api/hotspots/one_vuln.json"
    ) as json_file:
        data = json.load(json_file)
        return data
...
def dummy_many_hotspots(self, *args, **kwargs):
    with open(
        get_unit_tests_path() + "/scans/sonarqube_api/hotspots/many_vulns.json"
    ) as json_file:
        data = json.load(json_file)
        return data
...
def dummy_hotspot_rule(self, *args, **kwargs):
    with open(
        get_unit_tests_path() + "/scans/sonarqube_api/hotspots/rule.json"
    ) as json_file:
        data = json.load(json_file)
        return data
...
def dummy_hotspot_rule_wo_risk_description(self, *args, **kwargs):
    with open(
        get_unit_tests_path()
        + "/scans/sonarqube_api/hotspots/rule_wo_risk_description.json"
    ) as json_file:
        data = json.load(json_file)
        return data
...
class TestSonarqubeImporterOneSQToolConfig(DojoTestCase):
    ...
    @mock.patch(
        "dojo.tools.sonarqube_api.api_client.SonarQubeAPI.find_project", dummy_product
    )
    @mock.patch("dojo.tools.sonarqube_api.api_client.SonarQubeAPI.get_rule", dummy_rule)
    @mock.patch(
        "dojo.tools.sonarqube_api.api_client.SonarQubeAPI.find_issues", dummy_issues
    )
    @mock.patch(
        "dojo.tools.sonarqube_api.api_client.SonarQubeAPI.get_hotspot_rule",
        dummy_hotspot_rule,
    )
    @mock.patch(
        "dojo.tools.sonarqube_api.api_client.SonarQubeAPI.find_hotspots", empty_list
    )
    def test_parser(self):
...
class TestSonarqubeImporterMultipleSQToolConfig(DojoTestCase):
    ...
    def test_parser(self):
        with self.assertRaisesRegex(
            Exception, "More than one Tool Configuration for SonarQube exists."
        ):
            SonarQubeApiImporter.prepare_client(self.test)
...
class TestSonarqubeImporterOneSQConfigWithKey(DojoTestCase):
    ...
    @mock.patch(
        "dojo.tools.sonarqube_api.api_client.SonarQubeAPI.get_project", dummy_product
    )
    @mock.patch("dojo.tools.sonarqube_api.api_client.SonarQubeAPI.get_rule", dummy_rule)
    @mock.patch(
        "dojo.tools.sonarqube_api.api_client.SonarQubeAPI.find_issues", dummy_issues
...
class TestSonarqubeImporterSelectedSQConfigsWithKey(DojoTestCase):
    ...
    def test_product_mismatch(self):
        with self.assertRaisesRegex(
            Exception, "Product API Scan Configuration and Product do not match."
        ):
...
class TestSonarqubeImporterExternalRule(DojoTestCase):
    ...
    @mock.patch(
        "dojo.tools.sonarqube_api.api_client.SonarQubeAPI.get_rule",
        dummy_rule_wo_html_desc,
    )
    @mock.patch(
        "dojo.tools.sonarqube_api.api_client.SonarQubeAPI.find_issues", dummy_issues
    )
    ...
    def test_parser(self):
        ...
        self.assertEqual(
            "internal.dummy.project:src/main/javascript/TranslateDirective.ts",
            finding.file_path,
        )
...
class TestSonarqubeImporterNoIssuesOneHotspot(DojoTestCase):
    ...
    @mock.patch("dojo.tools.sonarqube_api.api_client.SonarQubeAPI.get_rule", dummy_rule)
    @mock.patch(
        "dojo.tools.sonarqube_api.api_client.SonarQubeAPI.find_issues", empty_list
    )
    @mock.patch(
        "dojo.tools.sonarqube_api.api_client.SonarQubeAPI.get_hotspot_rule",
        dummy_hotspot_rule,
    ...
    @mock.patch(
        "dojo.tools.sonarqube_api.api_client.SonarQubeAPI.find_hotspots",
        dummy_one_hotspot,
    )
    def test_parser(self):
        parser = SonarQubeApiImporter()
...
class TestSonarqubeImporterHotspotRule_WO_Risk_Description(DojoTestCase):
    ...
    @mock.patch(
        "dojo.tools.sonarqube_api.api_client.SonarQubeAPI.get_hotspot_rule",
        dummy_hotspot_rule_wo_risk_description,
    )
    @mock.patch(
        "dojo.tools.sonarqube_api.api_client.SonarQubeAPI.find_hotspots",
        dummy_one_hotspot,
