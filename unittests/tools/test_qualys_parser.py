...
class TestQualysParser(DojoTestCase):
    ...
    def test_parse_file_with_multiple_vuln_has_multiple_findings(self):
        ...
        for finding in findings:
            if (
                ...
                and finding.title
                == "QID-370876 | AMD Processors Multiple Security Vulnerabilities (RYZENFALL/MASTERKEY/CHIMERA-FW/FALLOUT)"
            ):
    ...
    def test_parse_file_with_multiple_vuln_has_multiple_findings_csv(self):
        ...
        self.assertEqual(finding.unsaved_endpoints[0].host, "10.98.57.180")
