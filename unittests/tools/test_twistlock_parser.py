...
class TestTwistlockParser(DojoTestCase):
    def test_parse_file_with_no_vuln(self):
        testfile = open(
            path.join(path.dirname(__file__), "../scans/twistlock/no_vuln.json")
        )
    ...
    def test_parse_file_with_one_vuln(self):
        testfile = open(
            path.join(path.dirname(__file__), "../scans/twistlock/one_vuln.json")
        )
        parser = TwistlockParser()
        findings = parser.get_findings(testfile, Test())
        testfile.close()
    ...
    def test_parse_file_with_no_link(self):
        testfile = open(
            path.join(
                path.dirname(__file__), "../scans/twistlock/one_vuln_no_link.json"
            )
        )
        parser = TwistlockParser()
        findings = parser.get_findings(testfile, Test())
    ...
    def test_parse_file_with_many_vulns(self):
        testfile = open(
            path.join(path.dirname(__file__), "../scans/twistlock/many_vulns.json")
        )
        parser = TwistlockParser()
        findings = parser.get_findings(testfile, Test())
        testfile.close()
    ...
    def test_parse_file_prisma_twistlock_images_no_vuln(self):
        testfile = open(
            path.join(
                path.dirname(__file__),
                "../scans/twistlock/scan_report_prisma_twistlock_images_no_vuln.csv",
            )
        )
        parser = TwistlockParser()
        findings = parser.get_findings(testfile, Test())
    ...
    def test_parse_file_prisma_twistlock_images_four_vulns(self):
        testfile = open(
            path.join(
                path.dirname(__file__),
                "../scans/twistlock/scan_report_prisma_twistlock_images_four_vulns.csv",
            )
        )
        parser = TwistlockParser()
        findings = parser.get_findings(testfile, Test())
    ...
    def test_parse_file_prisma_twistlock_images_long_package_name(self):
        testfile = open(
            path.join(
                path.dirname(__file__),
                "../scans/twistlock/scan_report_prisma_twistlock_images_long_package_name.csv",
            )
        )
        parser = TwistlockParser()
        findings = parser.get_findings(testfile, Test())
