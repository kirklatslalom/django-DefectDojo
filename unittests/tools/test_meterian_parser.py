...
class TestMeterianParser(DojoTestCase):
    ...
    def test_meterianParser_finding_has_fields(self):
        ...
        self.assertEqual(
            "7be36211-b569-30c0-8851-26b4bb8740ca", finding.unique_id_from_tool
        )
        ...
        self.assertTrue(
            "Upgrade date-and-time to version 0.14.2 or higher." in finding.mitigation
        )
        self.assertTrue(
            "https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2020-26289"
            in finding.references,
            "found " + finding.references,
        )
        self.assertTrue(
            "https://nvd.nist.gov/vuln/detail/CVE-2020-26289" in finding.references,
            "found " + finding.references,
        )
        self.assertTrue(
            "https://www.npmjs.com/package/date-and-time" in finding.references,
            "found " + finding.references,
        )
        self.assertTrue(
