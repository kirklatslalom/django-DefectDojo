...
class TestAcunetixParser(DojoTestCase):
    ...
    def test_parse_file_with_multiple_finding(self):
        ...
        with self.subTest(i=0):
            ...
            self.assertIsNotNone(finding.description)
            self.assertEqual(
                "CVSS:3.0/AV:N/AC:L/PR:N/UI:N/S:U/C:N/I:N/A:L", finding.cvssv3
            )
            self.assertFalse(finding.false_p)
            self.assertEqual(
        ...
        with self.subTest(i=1):
            ...
            self.assertIsNotNone(finding.description)
            self.assertEqual(
                "CVSS:3.0/AV:N/AC:L/PR:N/UI:N/S:U/C:H/I:N/A:N", finding.cvssv3
            )
            self.assertFalse(finding.false_p)
            self.assertEqual(
                "Possible sensitive information disclosure.", finding.impact
            )
            # check that this finding have references
            self.assertIsNotNone(finding.references)
            self.assertGreater(len(finding.references), 0)
        ...
        with self.subTest(i=2):
            ...
            self.assertIsNotNone(finding.description)
            self.assertEqual(
                "CVSS:3.0/AV:N/AC:L/PR:N/UI:N/S:U/C:H/I:H/A:N", finding.cvssv3
            )
            self.assertFalse(finding.false_p)
    ...
    def test_parse_file_with_example_com(self):
        ...
        with self.subTest(i=0):
            ...
            self.assertIsNotNone(finding.description)
            self.assertEqual(
                "CVSS:3.0/AV:N/AC:L/PR:N/UI:R/S:U/C:N/I:L/A:N", finding.cvssv3
            )
            self.assertFalse(finding.false_p)
            self.assertIn(
                "An attacker could use CSRF to trick a victim into accessing a website hosted by the attacker,",
                finding.impact,
            )
            # aggregated
        ...
        with self.subTest(i=6):
            finding = findings[6]
            self.assertEqual(
                "Content Security Policy (CSP) not implemented", finding.title
            )
            ...
            self.assertFalse(finding.false_p)
            self.assertIn(
                "CSP can be used to prevent and/or mitigate attacks that involve content/code injection,",
                finding.impact,
            )
            # check that this finding have references
            self.assertIsNotNone(finding.references)
