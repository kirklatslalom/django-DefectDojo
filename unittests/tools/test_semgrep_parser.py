...
class TestSemgrepParser(DojoTestCase):
    ...
    def test_parse_one_finding(self):
        ...
        self.assertEqual(
            "src/main/java/org/owasp/benchmark/testcode/BenchmarkTest02194.java",
            finding.file_path,
        )
        self.assertEqual(64, finding.line)
        self.assertEqual(696, finding.cwe)
        self.assertEqual(
            'javax crypto Cipher.getInstance("AES/GCM/NoPadding");', finding.mitigation
        )
        self.assertEqual(
        ...
        self.assertIn(
            "Using CBC with PKCS5Padding is susceptible to padding orcale attacks",
            finding.description,
        )
    ...
    def test_parse_many_finding(self):
        ...
        self.assertEqual(
            "src/main/java/org/owasp/benchmark/testcode/BenchmarkTest01150.java",
            finding.file_path,
        )
    ...
    def test_parse_many_vulns(self):
        ...
        self.assertEqual("High", finding.severity)
        self.assertEqual(
            "management/commands/csv_findings_export.py", finding.file_path
        )
