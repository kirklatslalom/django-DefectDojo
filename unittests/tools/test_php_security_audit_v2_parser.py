...
class TestPhpSecurityAuditV2ParserParser(DojoTestCase):
    def test_php_symfony_security_check_parser_with_no_vuln_has_no_findings(self):
        testfile = open(
            "unittests/scans/php_security_audit_v2/php_security_audit_v2.0.0_unformatted.json"
        )
        ...
        self.assertEqual(
            "/Applications/MAMP/htdocs/wordpress/wp-content/themes/twentyseventeen/inc/icon-functions.php",
            finding.file_path,
        )
        ...
        self.assertEqual("Medium", finding.severity)
        self.assertEqual(
            "/Applications/MAMP/htdocs/wordpress/wp-content/themes/twentyseventeen/index.php",
            finding.file_path,
        )
    ...
    def test_php_symfony_security_check_parser_with_many_vuln(self):
        ...
        self.assertEqual("Medium", finding.severity)
        self.assertEqual(
            "/home/xcvb/xfgkfhkhlj/bigbangwp/page-blog-2.php", finding.file_path
        )
        self.assertEqual(33, finding.line)
        finding = findings[200]
        self.assertEqual("Medium", finding.severity)
        self.assertEqual(
            "/home/xcvb/xfgkfhkhlj/bigbangwp/page-blog-6.php", finding.file_path
        )
