...
class TestRustyhogParser(DojoTestCase):
    def test_parse_file_with_no_vuln_has_no_finding_choctawhog(self):
        ...
        findings = parser.get_items(
            testfile, "Rusty Hog", Test()
    ...
    def test_parse_file_with_multiple_vuln_has_multiple_finding_choctawhog_content(
        ...
        self.assertIn(
            "**This string was found:** ['dojo-helpers@this-repo.com']",
    ...
    def test_parse_file_with_multiple_vuln_has_multiple_finding_durochog_content(self):
        ...
        self.assertIn(
            "**Diff:** $password = getEncryptedPass();", findings[0].description
        )
        self.assertIn(
    ...
    def test_parse_file_with_multiple_vuln_has_multiple_finding_gottingenhog_content(
        ...
        findings = parser.get_items(testfile, "Gottingen Hog", Test())
        self.assertEqual(
            findings[0].title, "password found in Jira ID TEST-123 (Issue Description)"
        )
        self.assertIn(
            "**This string was found:** ['password: jeans']", findings[0].description
        )
        ...
        self.assertIn(
            "**JIRA url:** https://jira.com/browse/TEST-123", findings[0].description
        )
        self.assertIn(
    ...
    def test_parse_file_with_multiple_vuln_has_multiple_finding_essexhog_content(self):
        ...
        findings = parser.get_items(testfile, "Essex Hog", Test())
        self.assertEqual(
            findings[0].title, "SSH (EC) private key found in Confluence Page ID 12345"
        )
